(function(){
  ...
  function deleteFolder(){
   ...
   let fidTBD = parseInt(divFolder.getAttribute("rid"));//folder to be deleted
  ...
  function deleteHelper(fidTBD){
    ...
    for(let i = 0; i < children.length; i++){
      deleteHelper(children[i].rid); //this is capable deleting its children
    }
  ...
  function deleteTextFile(){
    ...
    let fidTBD = parseInt(divTextFile.getAttribute("rid"));//folder to be deleted
    let fname = divName.innerHTML;
  ...
  function deleteAlbum(){
    ...
    let fidTBD = parseInt(divAlbum.getAttribute("rid"));//folder to be deleted
    let fname = divName.innerHTML;
  ...
  function renameFolder(){
    let nrname = prompt("Enter file's name"); //new rname(new name)
    ...
    let divName = divTextFile.querySelector("[purpose = name]");
    let orname = divName.innerHTML; //original name
    let ridTBU = parseInt(divTextFile.getAttribute("rid")); //rid to be updated
    if(nrname == orname){
  ...
  function renameTextFile(){
    let nrname = prompt("Enter folder's name"); //new rname(new name)
    ...
    let divName = divFolder.querySelector("[purpose = name]");
    let orname = divName.innerHTML; //original name
    let ridTBU = parseInt(divFolder.getAttribute("rid")); //rid to be updated
    if(nrname == orname){
      alert("Please enter a new name");
      return;
    }
  ...
  function renameAlbum(){
    let nrname = prompt("Enter album's name"); //new rname(new name)
  ...
  function viewFolder(){
    ...
    aPath.innerHTML = fname; //folder name
